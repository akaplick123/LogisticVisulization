...
public class ImportCSVFile {
  ...
  public ImportCSVFile(LocalDateTimeLookUp dateTimeLookup, Datacenter datacenter) {
  ...
  private static int isOneOf(int currentValue, int currentIdx, String currentPart,
      String... pattern) {
