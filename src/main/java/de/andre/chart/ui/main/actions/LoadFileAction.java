...
public class LoadFileAction implements ActionListener {
  ...
  public LoadFileAction(JDesktopPane desktop, JFrame mainFrame, Datacenter datacenter,
      LocalDateTimeLookUp dateTimeLookup, ThreadFinishedListener finishListener) {
  ...
  private void loadFiles(List<File> files) {
    ...
    ImportCSVFileThread importThread = new ImportCSVFileThread(files, dateTimeLookup, datacenter);
